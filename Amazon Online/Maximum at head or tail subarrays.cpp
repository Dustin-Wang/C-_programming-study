...
/*
THis is Amazon interview online test problem.
Given an integer array, find the no of subarrays where maximum element is either at the head of the subarray or at the end of the subarrays
...
int main(){
	...
	vector<int> input{3,1,5,2,4};//9+10+16
	
	mysol.printSubArrays(input);
