...
public:
    int count(string num1, string num2, int min_sum, int max_sum) {
        vector<int> DigitsInNum1(22,0);
        int num1Size = num1.size();
        for(int i=0; i<num1Size;i++)
        	DigitsInNum1[i]=num1[i]-'0';
        
        vector<int> DigitsInNum2(22,0);
        int num2Size = num2.size();
        for(int i=0;i<num2Size; i++)
        	DigitsInNum2[i]=num2[i]-'0';
        
        printvector(DigitsInNum1);
        printvector(DigitsInNum2);
        return(0);
...
int main(){
	...
	int min_sum =1;
	int max_sum = 8;
	cout<<mysol.count(num1, num2, min_sum, max_sum)<<endl;
