...
iven a positive integer num represented as a string, return the integer num without trailing zeros as a string.
...
int main(){
	...
	string s = "51230100";
	cout<<mysol.removeTrailingZeros(s)<<endl;
