...
int main(){
	...
	// }
  	...
  	// string word = "1010";
  	// int m = 10;
  	string word = "641770318471366266679729826266679777211350732329811266679745308703298458572010861577626667968134562136326667976028761918809582469329982666796698426667978152666797884951266679774262666797857121803678266679750689";
	int m = 266679793;
  	printvector(mysol.divisibilityArray(word, m));
 	return(0);	
}