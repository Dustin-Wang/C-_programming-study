...
public:
    int maxNonDecreasingLength(vector<int>& nums1, vector<int>& nums2) {
        ...
        for(int i=1; i<n; i++)
        {
        	...
        	LastValueForSubarrayLengthEndAtCur[0]=min(nums1[i], nums2[i]);
        	printvector(LastValueForSubarrayLengthEndAtCur);
...
int main(){
	...
	vector<int> nums1{12,10};
	vector<int> nums2{16,2};
