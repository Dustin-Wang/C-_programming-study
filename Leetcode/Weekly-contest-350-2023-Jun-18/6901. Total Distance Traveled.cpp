...
public:
    int distanceTraveled(int mainTank, int additionalTank) {
        ...
        while( FiveLs >0 )
        {
        	...
        	res += FiveLs*50;
        	mainTank = mainTank%5;
        	mainTank = min(additionalTank, FiveLs) + mainTank;

        	additionalTank = additionalTank-min(additionalTank, FiveLs);
        }
        res += mainTank*10;
        return(res);
    }
...
int main(){
	...
	cout<<mysol.distanceTraveled(mainTank, additionalTank)<<endl;
