...
public:
    int maxNonDecreasingLength(vector<int>& nums1, vector<int>& nums2) {
        ...
        int res = 1;
        // vector<int> LengthOfSubarrayUsingNums1Or2EndAtI(2,-1);
        int LengthOfSubarrayUsingNums1=1;//index = 0 means that the subarray end at I got last element from nums1
        int LengthOfSubarrayUsingNums2=1;//index = 1 means that the subarray end at I got last element from nums2
        
        for(int i=1; i<n; i++)
        {
        	int NewLengthOfSubarrayUsingNums1=1;
        	int NewLengthOfSubarrayUsingNums2=1;
        	// printf("i:%d\n", i);
        	// printf("LengthOfSubarrayUsingNums1: %d\n", LengthOfSubarrayUsingNums1);
        	// printf("LengthOfSubarrayUsingNums2: %d\n", LengthOfSubarrayUsingNums2);
        	if(nums1[i]>=nums1[i-1])
        		NewLengthOfSubarrayUsingNums1 = max(LengthOfSubarrayUsingNums1+1, NewLengthOfSubarrayUsingNums1);
        	if(nums1[i]>=nums2[i-1])
        		NewLengthOfSubarrayUsingNums1 = max(LengthOfSubarrayUsingNums2+1, NewLengthOfSubarrayUsingNums1);

			if(nums2[i]>=nums1[i-1])
        		NewLengthOfSubarrayUsingNums2 = max(LengthOfSubarrayUsingNums1+1, NewLengthOfSubarrayUsingNums2);
        	if(nums2[i]>=nums2[i-1])
        		NewLengthOfSubarrayUsingNums2 = max(LengthOfSubarrayUsingNums2+1, NewLengthOfSubarrayUsingNums2);

        	LengthOfSubarrayUsingNums1= NewLengthOfSubarrayUsingNums1;
        	LengthOfSubarrayUsingNums2= NewLengthOfSubarrayUsingNums2;
        	// printf("i:%d\n", i);
        	// printf("newLengthOfSubarrayUsingNums1: %d\n", NewLengthOfSubarrayUsingNums1);
        	// printf("newLengthOfSubarrayUsingNums2: %d\n", NewLengthOfSubarrayUsingNums1);
        	res = max(res, LengthOfSubarrayUsingNums2);
        	res = max(res, LengthOfSubarrayUsingNums1);
        }
        return(res);
    }
private:
...
int main(){
	...
	cout<<mysol.maxNonDecreasingLength(nums1, nums2)<<endl;
