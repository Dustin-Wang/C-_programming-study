...
public:
    long long dividePlayers(vector<int>& skill) {
        ...
        int TwoSum = skill[0]+skill[skillLength-1];
        long long res = skill[0]*skill[skillLength-1];
        for(int i=1; i<skillLength/2;i++){
        	if(skill[i]+skill[skillLength-1-i] != TwoSum)
        		return(-1);
        	else{
        		res = res + skill[i]*skill[skillLength-1-i];
        	}
        }
        return(res);
    }
...
int main(){
	...
	cout<<mysol.dividePlayers(skills)<<endl;
